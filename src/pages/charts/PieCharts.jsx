...
import { DoughnutChart } from '../../components/admin/Chart'
    ...
    <div className='admin-container'>
      ...
      <main className='chart-container'>
        ...
        <section>
            <div>
                <DoughnutChart 
                labels={categories.map((e)=> e.heading)}
                data={categories.map((e)=> e.value)}
                backgroundColor={categories.map((e)=> `hsl(${e.value*4},${e.value}%,50%)`)}
                legends={false}
                offset={[0,0,0,80]}
                />
            </div>
